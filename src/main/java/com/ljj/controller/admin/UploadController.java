...
import com.ljj.config.MyBlogWebMvcConfigurer;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        File fileDirectory = new File(MyBlogWebMvcConfigurer.FILE_UPLOAD_DIC);
        //创建文件
        File destFile = new File(MyBlogWebMvcConfigurer.FILE_UPLOAD_DIC + newFileName);
        try {
